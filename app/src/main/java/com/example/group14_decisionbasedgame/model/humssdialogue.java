...
public class humssdialogue {
    ...
    private static String H6_1 = "Hmmm. . . within my knowledge and our club president's view I shall accept the proposed name.";
    ...
    public static String getH6_1() { return H6_1; }
